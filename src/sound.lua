...
sound.music = {
	[0] = nil,
	[1] = love.audio.newSource("data/sounds/music/intense.ogg", "stream"),
	[2] = love.audio.newSource("data/sounds/music/busy.ogg", "stream"),
	[3] = love.audio.newSource("data/sounds/music/intro.ogg", "stream"),
	[4] = love.audio.newSource("data/sounds/music/riverside.ogg", "stream"),
	[5] = love.audio.newSource("data/sounds/music/exploration.ogg", "stream"),
	[6] = love.audio.newSource("data/sounds/music/rainbow.ogg", "stream"),
	[7] = love.audio.newSource("data/sounds/music/level_complete.ogg", "stream"),
	[8] = love.audio.newSource("data/sounds/music/fight.ogg", "stream"),
	[9] = love.audio.newSource("data/sounds/music/paradise.ogg", "stream"),
	[10] = love.audio.newSource("data/sounds/music/happy.ogg", "stream"),
	[11] = love.audio.newSource("data/sounds/music/grasslands.ogg", "stream"),
	[12] = love.audio.newSource("data/sounds/music/raspberry_jam.ogg", "stream"),
	[13] = love.audio.newSource("data/sounds/music/happysynth.ogg", "stream"),
	[14] = love.audio.newSource("data/sounds/music/galacticfunk.ogg", "stream"),
	[15] = love.audio.newSource("data/sounds/music/weaponchange.ogg", "stream"),
}
